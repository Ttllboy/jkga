 ...
 * @date 2022-05-15
 */
public interface LtdqExcessivestatisticaldataMapper 
{
    /**
     * 查询扬尘数据
     * 
    ...
    public List<LtdqExcessivestatisticaldata> selectList(LtdqExcessivestatisticaldata ltdqExcessivestatisticaldata);
