...
import static com.ruoyi.jkza.lib.NetSDKLib.*;
...
public class FACERECOGNITION_PERSON_INFOEX extends SdkStructure {
    ...
    public NetSDKLib.CUSTOM_PERSON_INFO[]    szCustomPersonInfo = new NetSDKLib.CUSTOM_PERSON_INFO[NET_MAX_CUSTOM_PERSON_INFO_NUM];    //注册人员信息扩展
