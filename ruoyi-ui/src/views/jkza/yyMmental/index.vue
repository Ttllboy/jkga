<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="110px">
      ...
      <!--  </el-date-picker>-->
      <!--</el-form-item>-->
      <!--<el-form-item label="病人数量" prop="people">-->
      <!--  <el-input-->
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['jkza:yyMmental:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['jkza:yyMmental:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['jkza:yyMmental:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="yyMmentalList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="病人数量" align="center" prop="people" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="病人数量" prop="people">
          <el-input v-model="form.people" placeholder="请输入病人数量" />
        </el-form-item>
<!--        <el-form-item label="数据类型" prop="dataType">-->
...
<script>
import { listYyMmental, getYyMmental, delYyMmental, addYyMmental, updateYyMmental } from "@/api/jkza/yyMmental";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listYyMmental(this.queryParams).then(response => {
        this.yyMmentalList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateYyMmental(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addYyMmental(this.form).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除精神病人编号为"' + ids + '"的数据项？').then(function() {
        return delYyMmental(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('jkza/yyMmental/export', {
        ...this.queryParams
      }, `yyMmental_${new Date().getTime()}.xlsx`)
    },
    //改变queryParams所属街道ID
