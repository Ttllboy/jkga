<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="低洼点ID" prop="lowpointId">
        <el-input
          v-model="queryParams.lowpointId"
          placeholder="请输入低洼点ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="避灾点ID" prop="bzdId">
        <el-input
          v-model="queryParams.bzdId"
          placeholder="请输入避灾点ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="yjVideoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="低洼点ID" align="center" prop="lowpointId" />
      <el-table-column label="避灾点ID" align="center" prop="bzdId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="低洼点ID" prop="lowpointId">
          <el-input v-model="form.lowpointId" placeholder="请输入低洼点ID" />
        </el-form-item>
        <el-form-item label="避灾点ID" prop="bzdId">
          <el-input v-model="form.bzdId" placeholder="请输入避灾点ID" />
        </el-form-item>
        <el-form-item label="驾驶舱ID" prop="jscId">
...
<script>
import { listYjVideo, getYjVideo, delYjVideo, addYjVideo, updateYjVideo } from "@/api/jkza/yjVideo";
